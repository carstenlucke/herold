...
| [N2](N2-querschnittskonzepte.md) | Authentication and TOTP handling underpin [UC-01](#uc-01--sign-in) to [UC-04](#uc-04--sign-out); type-driven configuration and validation cut across [UC-05](#uc-05--capture-voice-note), [UC-06](#uc-06--process-voice-note), [UC-07](#uc-07--edit-generated-content), [UC-08](#uc-08--dispatch-voice-note). |
